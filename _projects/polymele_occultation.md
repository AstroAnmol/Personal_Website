...
You can find the latest updates on the mission <a href = "https://lucy.swri.edu/Features.html">here</a>. 
...
Occultation is similar to eclipses; instead of the moon or the Earth blocking the light from the sun, an asteroid passes in front of a star and blocks its light.
By observing this occultation from multiple locations on Earth, scientists can construct the shape of the said asteroid.
One of Lucy's target asteroids, called Polymele, revealed more than just its shape.
During a campaign in 2022, scientists discovered that Polymele may actually be a binary asteroid, which may have a moon. They nicknamed this object Shaun.
...
The Lucy team identified a need for 100 telescopes deployed across the central USA for this campaign.
...
The third night, we traveled and practiced setting up the telescope on the roadside in a parking lot.
On the occultation day, we traveled the whole day to end up in Kansas, where we set up and recorded the telescope on a dirt road near Salina, KS.
